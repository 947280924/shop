...
<div id="urHere">DouPHP 管理中心<b></b><strong>商品列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="?r=goods/add_goods" class="actionBtn add">添加商品</a>商品列表</h3>
    <div class="filter">
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       ...
       <th width="80" align="center">生成货品</th>
        <th width="80" align="center">操作</th>
      </tr>
        <?php foreach ($goods_data as $k => $v): ?>
                  <tr>
              <td align="center"><input type="checkbox" name="checkbox[]" value="<?php echo $v['goods_id']?>" /></td>
              <td align="center"><?php echo $v['goods_id']?></td>
              <td><a href="product.php?rec=edit&id=<?php echo $v['goods_id']?>"><?php echo $v['goods_name']?></a></td>
              <td align="center"><a href="product.php?cat_id=3"><?php echo $v['cat_name']?></a></td>
              <td align="center">2013-06-26</td>
              <td align="center"><?php if (empty($v['product_id'])) {
                echo '<a href="?r=goods/add_product&goods_id='.$v['goods_id'].'">生成货品</a>';
              } else {
                echo '<a href="demo">查看货品</a>';
              }
              ?></td>
              <td align="center">
