...
<div class="Reg_log_style">
 ...
 <div class="right_img"><img src="images/bg_name_05.png" /></div>
    ...
    <div class="login_m_1">
     <div class="add_login">
  <ul>
   <li class="frame_style"><label class="user_icon"></label><input name="" type="text"  id="user_text"/></li>
   <li class="frame_style"><label class="password_icon"></label><input name="" type="password"   id="tbPassword"/></li>
  </ul>
